-- Exercises for Aggregate Functions (MySQL)
-- No answers, only questions/tasks. See README for instructions.
...
-- 9. (Medium)
-- For each category, show the number of active apps (is_active = TRUE).
